...
public class AggregateInfluenceMapper
  ...
  implements Mapper<LongWritable, Text, Text, Text>
{
    ...
    throws IOException
  {
    ...
    {
      localText1.set(((String)localArrayList.get(0)).getBytes());
      localText2.set(((String)localArrayList.get(1)).getBytes());
      paramOutputCollector.collect(localText1, localText2);
    }
  }
}
